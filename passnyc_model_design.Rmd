...
names(shsat) <- tolower(str_replace_all(names(tests), " |/", "_"))
```
...
Next, we'll subset the SHSAT data provided in order to gain a single observation per school (i.e. `dbn`).
